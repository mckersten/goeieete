	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-name"><?php esc_html_e( 'Artikel', 'woocommerce' ); ?></th>
				<th class="product-weight"><?php esc_html_e( 'Weight', 'woocommerce' ); ?></th>
				<th class="product-price"><?php esc_html_e( 'Prijs', 'woocommerce' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Aantal stuks', 'woocommerce' ); ?></th>
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-weight" data-title="<?php esc_attr_e( 'Weight', 'woocommerce' ); ?>">
							...
							//print_r($total_count);
							//$values_kgs=WC()->cart->cart_contents_weight . ' ' . get_option('woocommerce_weight_unit'); 
