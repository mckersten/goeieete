...
class ap_login_form{
	...
	public function loginForm( $wid_id = '' ){
		...
		<div class="log-form-group">
			<label style="display:none" for="userusername"><?php _e('Username','login-sidebar-widget');?> </label>
			<input type="text" name="userusername" placeholder="E-mail" id="userusername" required title="
			Dit veld is verplicht." <?php do_action( 'lwws_userusername_field' );?>/>
		</div>
		<div class="log-form-group">
			<label style="display:none" for="userpassword"><?php _e('Password','login-sidebar-widget');?> </label>
			<input type="password" name="userpassword"  placeholder="Wachtwoord	" id="userpassword" required title="
			Dit veld is verplicht." <?php do_action( 'lwws_userpassword_field' );?>/>
		</div>
		...
		<h3 style="text-align:center"><a href="<?php echo site_url('/my-account/lost-password/')?>">Wachtwoord vergeten?</a><h3>
