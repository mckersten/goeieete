<?php
	...
	class woocommerce_idealcheckout_manualtransfer extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_manualtransfer';
			$this->method_title = 'iDEAL Checkout - Handmatig overboeken';
			$this->icon = plugins_url('assets/images/manualtransfer.png', __FILE__);
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable Handmatig overboeken Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - Handmatig overboeken'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_manualtransfer($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_manualtransfer'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_manualtransfer');
