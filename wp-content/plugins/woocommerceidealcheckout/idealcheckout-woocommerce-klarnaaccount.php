<?php
	...
	class woocommerce_idealcheckout_klarnaaccount extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_klarnaaccount';
			$this->method_title = 'iDEAL Checkout - KlarnaAccount';
			$this->icon = plugins_url('assets/images/klarnaaccount.png', __FILE__);
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable KlarnaAccount Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - KlarnaAccount'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_klarnaaccount($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_klarnaaccount'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_klarnaaccount');
