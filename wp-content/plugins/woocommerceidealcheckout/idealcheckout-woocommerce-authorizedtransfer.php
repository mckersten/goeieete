<?php
	...
	class woocommerce_idealcheckout_authorizedtransfer extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_authorizedtransfer';
			$this->method_title = 'iDEAL Checkout - Eenmalige machtiging';
			$this->icon = plugins_url('assets/images/authorizedtransfer.png', __FILE__);
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable Eenmalige machtiging Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - Eenmalige machtiging'); ?></h3>
...
<?php
		...
		public function process_payment($order_id)
		{
			...
			$sStoreCode = '';
			$sGatewayCode = 'authorizedtransfer';
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_authorizedtransfer($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_authorizedtransfer'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_authorizedtransfer');
