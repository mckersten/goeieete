<?php
	...
	class woocommerce_idealcheckout_klarnainvoice extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_klarnainvoice';
			$this->method_title = 'iDEAL Checkout - KlarnaInvoice';
			$this->icon = plugins_url('assets/images/klarnainvoice.png', __FILE__);
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable KlarnaInvoice Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - KlarnaInvoice'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_klarnainvoice($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_klarnainvoice'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_klarnainvoice');
