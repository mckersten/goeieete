<?php
	...
	class woocommerce_idealcheckout_maestro extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_maestro';
			$this->method_title = 'iDEAL Checkout - Maestro';
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable Maestro Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - Maestro'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_maestro($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_maestro'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_maestro');
