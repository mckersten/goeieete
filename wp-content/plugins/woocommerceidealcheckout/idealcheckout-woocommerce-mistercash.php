<?php
	...
	class woocommerce_idealcheckout_mistercash extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_mistercash';
			$this->method_title = 'iDEAL Checkout - MisterCash';
			$this->icon = plugins_url('assets/images/mistercash.png', __FILE__);
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable MisterCash Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - MisterCash'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_mistercash($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_mistercash'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_mistercash');
