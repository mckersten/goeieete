<?php
	...
	class woocommerce_idealcheckout_visa extends WC_Payment_Gateway
	{
		public function __construct()
		{
			global $woocommerce;

			$this->id = 'idealcheckout_visa';
			$this->method_title = 'iDEAL Checkout - Visa';
			$this->icon = plugins_url('assets/images/visa.png', __FILE__);
		...
		public function init_form_fields()
		{
			$this->form_fields = array(
				'enabled' => array(
					...
					'type' => 'checkbox',
					'label' => idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'Enable Visa Payment'),
					'default' => 'no'
				),
				'title' => array(
		...
		{
?>
<h3><?php echo idealcheckout_getTranslation($this->getLanguageCode(), 'woocommerce', 'iDEAL Checkout - Visa'); ?></h3>
...
`transaction_log` = NULL;";
	...
	function woocommerce_add_idealcheckout_visa($methods) 
	{
		$methods[] = 'woocommerce_idealcheckout_visa'; 
		return $methods;
	}

	add_filter('woocommerce_payment_gateways', 'woocommerce_add_idealcheckout_visa');
