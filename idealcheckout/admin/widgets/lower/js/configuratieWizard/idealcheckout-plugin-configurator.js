	...
	function createConfigFile(f_element_id, f_step)
	{
		...
		if(f_step == 'step1')
		{
			...
			else if(sGATEWAY == 'iDEAL Simulator - iDEAL Advanced/Professional')
			{
				sHtml += '<div><b>Merchant ID</b></div>';
				sHtml += '<div><input class="text" id="idealcheckout_merchant_id" value="123456789"></div>';
				sHtml += '<div><b>Sub ID</b></div>';
				sHtml += '<div><input class="text" id="idealcheckout_sub_id" value="0"></div>';
				sHtml += '<div><b>Test Mode</b></div>';
				sHtml += '<div><select id="idealcheckout_test_mode" ><option value="true">Ja (Test betalingen)</option><option value="false">Nee (Echte betalingen)</option></select></div>';
				sHtml += '<div><b>Private Key Pass</b></div>';
				sHtml += '<div><input class="text" id="idealcheckout_private_key_pass" value="Password"></div>';
				sHtml += '<div><b>Private Key File</b></div>';
				sHtml += '<div><input class="text" id="idealcheckout_private_key_file" value="private.key"></div>';
				sHtml += '<div><b>Private Certificate File</b></div>';
				sHtml += '<div><input class="text" id="idealcheckout_private_certificate_file" value="private.cer"></div>';
			}
			else if(sGATEWAY == 'iDEAL Simulator - iDEAL Basic/Lite')
			{
				sHtml += '<div><b>Merchant ID</b></div>';
				sHtml += '<div><input class="text" id="idealcheckout_merchant_id" value="123456789"></div>';
				sHtml += '<div><b>Sub ID</b></div>';
				...
				sHtml += '<div><b>Test Mode</b></div>';
				sHtml += '<div><select id="idealcheckout_test_mode" ><option value="true">Ja (Test betalingen)</option><option value="false">Nee (Echte betalingen)</option></select></div>';
				sHtml += '<div><b>Hash Key</b></div>';
				sHtml += '<div><input class="text" id="idealcheckout_hash_key" value="Password"></div>';
			}
		...
		else if(f_step == 'step2')
		{
			...
			else if(sGATEWAY == 'iDEAL Simulator - iDEAL Advanced/Professional')
			{
				...
				sHtml += LF;
				sHtml += TAB + '// Basic gateway settings' + LF;
				sHtml += TAB + '$aSettings[\'GATEWAY_NAME\'] = \'iDEAL Simulator - iDEAL Professional\';' + LF;
	...
	function setGateways(sPSP)
	{
		...
		if(bMSIE)
		{
			...
			else if((sPSP == 'idealcheckout') || (sPSP == 'idealsimulator'))
			{
				...
				var oOptionElement = document.createElement('option');
				oOptionElement.value = 'iDEAL Simulator - iDEAL Advanced/Professional';
				oOptionElement.innerText = 'iDEAL Advanced/Professional';
				oSelectElement.appendChild(oOptionElement);

				var oOptionElement = document.createElement('option');
				oOptionElement.value = 'iDEAL Simulator - iDEAL Basic/Lite';
				oOptionElement.innerText = 'iDEAL Basic/Lite';
				oSelectElement.appendChild(oOptionElement);
