<?php
	...
	if(!empty($_POST['form']) && (strcasecmp($_POST['form'], 'delete-install') === 0))
	{
		...
		header('Location: ' . idealcheckout_getRootUrl(1) . 'admin');
		exit;
	}
	...
	<tr>
		<td><p>Na het verwijderen van de installatie wizard, wordt u automatisch verwezen naar de iDEAL Checkout beheeromgeving.<br>Mocht u de wizard nogmaals willen uitvoeren om van configuratie te wisselen kunt u deze behouden door de wizard af te sluiten.<br>Het verwijderen word geadviseerd om veiligheids redenen, denk aan het wijzigen van de betaalmethode configuratie.</p></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
